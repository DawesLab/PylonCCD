...
# seems best way to model (classical) detector 
# is with partial loss (2%) and added noise (dark counts)
...
# the center @ 512) 131 pixels corresponds to the off-axis 
# component of the wave: ∆K is 2π / (20e-6 * 1024) = 306.796 rad/m
